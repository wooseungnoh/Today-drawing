...
})(["margin:10px;border:none;outline:none;width:300px;height:25px;background:#e3d3bc;border-radius:5px;transition:0.3s;color:#555;box-shadow:1px 1px 3px;&:hover{background:#d1c3ae}&:active{box-shadow:inset 1px 1px 3px;background:#d1c3ae;}"]);
...
//# sourceMappingURL=[imgDetail].js.50998a7e272178a7060f.hot-update.js.map