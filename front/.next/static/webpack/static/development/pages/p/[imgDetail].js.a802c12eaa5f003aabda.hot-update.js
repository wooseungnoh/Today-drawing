...
})(["margin:10px;border:none;outline:none;width:300px;height:25px;background:#e3d3bc;border-radius:5px;transition:0.3s;color:#555;box-shadow:1px 1px 3px;&:hover{background:#f0e1cc;}&:active{box-shadow:inset 1px 1px 3px;background:#e3d3bc;}"]);
...
//# sourceMappingURL=[imgDetail].js.a802c12eaa5f003aabda.hot-update.js.map