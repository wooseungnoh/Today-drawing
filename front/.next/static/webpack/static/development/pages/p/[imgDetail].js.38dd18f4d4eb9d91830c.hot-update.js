...
})(["margin:10px;border:none;outline:none;width:300px;height:25px;background:#e3d3bc;border-radius:5px;transition:0.3s;color:#555;box-shadow:2px 2px 2px;&:hover{background:#ccc;}&:active{background:#888;}"]);
...
//# sourceMappingURL=[imgDetail].js.38dd18f4d4eb9d91830c.hot-update.js.map