...
})(["margin:10px;border:none;outline:none;width:300px;height:25px;background:#e3d3bc;border-radius:5px;transition:0.3s;color:#555;box-shadow:1px 1px 3px;&:hover{background:#ccc;}&:active{background:#888;}"]);
...
//# sourceMappingURL=[imgDetail].js.4fdf8a4b92386ba27a0b.hot-update.js.map