...
})(["margin:10px;border:none;outline:none;width:300px;height:25px;background:#e3d3bc;border-radius:5px;transition:0.3s;color:#555;box-shadow:1px 1px 3px;&:hover{background:#ccc;}&:active{box-shadow:inset 1px 1px 3px;background:#888;}"]);
...
//# sourceMappingURL=[imgDetail].js.3282c8d2cd49c8a30ad3.hot-update.js.map