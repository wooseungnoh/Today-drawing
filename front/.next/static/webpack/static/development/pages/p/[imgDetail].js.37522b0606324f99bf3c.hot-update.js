...
var imgDetail = function imgDetail() {
  ...
  var onChangeData = function onChangeData(e) {
    e.preventDefault();
    console.log(e.target.childNodes[2].value, e.target.childNodes[4].value);
    dispatch({
      type: EDIT_PHOTO_DETAIL_REQUEST,
      data: {
        id: nowShowingPost.post
      }
    });
  };
...
//# sourceMappingURL=[imgDetail].js.37522b0606324f99bf3c.hot-update.js.map