...
})(["margin:10px;border:none;outline:none;width:300px;height:25px;background:#e3d3bc;border-radius:5px;transition:0.3s;color:#555;&:hover{background:#f0e1cc;}&:active{box-shadow:inset 2px 2px 3px;background:#e3d3bc;}"]);
...
//# sourceMappingURL=[imgDetail].js.5cd6135f34bf8600f0b9.hot-update.js.map