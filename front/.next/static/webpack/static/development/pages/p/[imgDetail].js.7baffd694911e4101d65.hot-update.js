...
})(["margin:10px;border:none;outline:none;width:300px;height:25px;background:#e3d3bc;border-radius:5px;transition:0.3s;color:#555;box-shadow:1px 1px 3px;&:hover{box-shadow:1px 1px 3px;background:#ccc;}&:active{background:#888;}"]);
...
//# sourceMappingURL=[imgDetail].js.7baffd694911e4101d65.hot-update.js.map