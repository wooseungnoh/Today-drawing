...
})(["margin:10px;border:none;outline:none;width:300px;height:25px;background:#e3d3bc;border-radius:5px;transition:0.3s;color:#555;box-shadow:1px 1px 3px;&:hover{background:#f0e1cc}&:active{box-shadow:inset 1px 1px 3px;background:#d1c3ae;}"]);
...
//# sourceMappingURL=[imgDetail].js.b1ca66d0826747c45882.hot-update.js.map