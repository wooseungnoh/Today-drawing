...
})(["height:10px;display:flex;flex-direction:row-reverse;justify-content:center;align-items:center;transform:rotate(-90deg);position:absolute;right:10;"]);
...
})(["position:absolute;width:", "px;height:", "px;background:#000000;border-radius:50%;transform:translateX(120px);"], function (_ref) {
  var size = _ref.size;
  return size || '2.5';
}, function (_ref2) {
  var size = _ref2.size;
...
//# sourceMappingURL=upload.js.f78824dc3b7e3dc5f456.hot-update.js.map